...
private slots:
    ...
    QString BuyAFRO(QString OrderType, double Quantity, double Rate);
    QString SellAFRO(QString OrderType, double Quantity, double Rate);
