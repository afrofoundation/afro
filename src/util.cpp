...
int nAnonymizeAFROAmount = 500000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\AFRO
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\AFRO
    // Mac: ~/Library/Application Support/AFRO
    // Unix: ~/.AFRO
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "AFRO";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "AFRO.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "AFROd.pid"));
